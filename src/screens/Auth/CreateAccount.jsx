...
const CreateAccount = () => {
    ...
    const { register, errors, isSubmitting, setErrors } = useAuthContext();
            ...
            <div className='w-full flex flex-col justify-center items-center min-h-screen py-20'>
                ...
                <form className="w-[340px] md:w-[400px]" onSubmit={handleSubmit}>
                    ...
                    <div className="w-full px-3 relative">
                        <label className="p-700 block uppercase tracking-wide text-gray-700 text-sm font-bold mb-2">
                            First name
                        </label>
                        <input
                        ...
                        />
                        {error.first_name && <div className="text-red-500 -mt-2 mb-2">{error.first_name}</div>}
                    </div>
                    ...
                    <div className="w-full px-3 relative">
                        ...
                        />
                        {error.last_name && <div className="text-red-500 -mt-2 mb-2">{error.last_name}</div>}
                    </div>
                    ...
                    <div className="w-full px-3 relative">
                        ...
                        <input
                            ...
                            value={email}
                        />
                        {error.email && <div className="text-red-500 -mt-2 mb-2">{error.email}</div>}
                    </div>
                    ...
                    <div className="w-full px-3 relative">
                        ...
                        {error.password && <div className="text-red-500 -mt-2 mb-2">{error.password}</div>}
                    </div>
                    ...
                    <div className="w-full px-3 relative">
                        ...
                        {error.confirmPassword && <div className="text-red-500 -mt-2 mb-2">{error.confirmPassword}</div>}
                    </div>
