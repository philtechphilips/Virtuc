        ...
        <form className="w-[340px] md:w-[400px]" onSubmit={handleSubmit}>
          <div className="flex flex-wrap -mx-3 mb-6">
            ...
            <div className="w-full px-3 relative">
              ...
              <span
                className="absolute top-9 right-5 p-600 px-2 text-sm py-1 text-gray-800 cursor-pointer"
                onClick={editEmail}>
                Edit
              </span>
            </div>
            ...
            <div className="w-full px-3 relative">
              ...
              <input className="p-400 appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type={`${isPasswordVisible ? 'text' : 'password'}`} placeholder='Enter your password' value={password} onChange={(e) => { setPassword(e.target.value) }} />
              <span
