...
const Banners = () => {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            buttonUrl: Yup.mixed().required("Button text is required!"),
                            ...
                            <form onSubmit={formik.handleSubmit}>
                                ...
                                <div className="w-full flex flex-wrap justify-between">
                                    <div className="mb-4 mt-4 w-full pr-3">
                                        ...
                                        <input type="text" placeholder="Enter banner body text" className="appearance-none border text-sm rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="buttonUrl" ></input>
